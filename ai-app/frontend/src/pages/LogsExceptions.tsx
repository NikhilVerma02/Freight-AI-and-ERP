  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-xl font-semibold text-slate-100">{t("logs.title")}</h1>
                ...
                {logs.map((log, i) => (
                  <React.Fragment key={i}>
                    <Tr>
                      ...
                      <Td className="text-xs">{log.latency_ms ? `${log.latency_ms.toFixed(0)}ms` : "—"}</Td>
                      <Td>
                        <button
                    ...
                    {expanded === i && (
                      <tr>
                        <td colSpan={6} className="bg-slate-950/60 px-4 py-3">
                          {log.error && (
